...
namespace ZarulIzham\EMandate\Traits;

use ZarulIzham\EMandate\Exceptions\InvalidCertificateException;
use Carbon\Carbon;
...
trait VerifyCertificate
{
     ...
     * @param string $data
     *
     * @throws \ZarulIzham\EMandate\Exceptions\InvalidCertificateException
     * @return bool
     */
     ...
     * @return string
     */
    public function decodeSignature($signature): string
    {
