...
use ZarulIzham\EMandate\Traits\VerifyCertificate;
use ZarulIzham\EMandate\Events\EMandateTransactionUpdated;
...
class AuthorizationRequest extends Message implements Contract
{
    ...
    public function handle($options)
    {
        ...
        // $this->buyerMakerName = $data['additional_params'];
        $this->buyerIBAN = $data['buyerIban'];
    ...
    {
        $transaction = new EMandateTransaction;
        ...
        event(new EMandateTransactionUpdated($transaction));
    }
}
